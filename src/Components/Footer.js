    ...
    <div className="mx-auto max-w-md">
      ...
      <form className="mt-6">
        <div className="relative max-w-lg">
          ...
          <button
            className="absolute end-1 top-1/2 -translate-y-1/2 rounded-full bg-gray-600 px-5 py-3 text-sm font-medium text-white transition hover:bg-white hover:text-black"
          >
            Subscribe
          </button>
        </div>
